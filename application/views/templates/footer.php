<div class="text-center">
	...
	<p  id="hint" class="colwhite1 Dagger " type="button" data-toggle="modal" data-target="#myModal">Credits</p>
  ...
  <div class="modal-dialog Dagger">
    <div class="modal-content"  style="background-color:rgba(15,149,145,0.8);">
      <div class="modal-header">
        
        <h2 class="colwhite modal-title text-center Dagger600">Incognito Team</h2>
      </div>
        ...
        <div class="container">
          ...
          <div class="row">
             <a href="https://www.facebook.com/jerry.j.sebastian"><img class="" src="<?php echo base_url('assets/img/img1.jpg')?>"></a>
                   ...
                   <div class="row">
             <p class="Dagger colwhite">Jerry James</p>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="buttonfb btn Dagger" style="color: white;" data-dismiss="modal">Close</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
